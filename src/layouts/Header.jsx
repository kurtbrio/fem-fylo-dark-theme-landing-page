...
const Header = () => {
  ...
  return (
    <header className="w-full bg-email-bg light:bg-email-bg-light flex justify-between items-center overflow-hidden p-5 lg:py-10 lg:px-16">
      <div className="fill-custom-white light:fill-lightmode">
        <svg
      ...
      <ul className="flex justify-between gap-5">
        <li className="hover:text-white hover:underline light:hover:text-black">
          Features
        </li>
        <li className="hover:text-white hover:underline light:hover:text-black">
          Team
